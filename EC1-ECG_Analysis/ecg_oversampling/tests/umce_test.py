...
class TestUMCE(object):
    ...
    # Safety ArtISt - Deactivated 'pytext given' to run the code on VS Code without needing pytest.
    # All combinations of class_counts and num_features are generated by means of 'for' loops within
    # 'sa_umce_test.py' component.
