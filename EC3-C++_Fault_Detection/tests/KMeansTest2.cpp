...
int KMeansTest2()
{
	...
	data::Load("tests/data/TestsKMeansSilhouette/Example2/data.csv", data, true);
	data::Load("tests/data/TestsKMeansSilhouette/Example2/centroids.csv", centroids, true);
	...
	data::Save("tests/data/TestsKMeansSilhouette/Example2/assignments.csv", KClusters.getAssigments(), true);
	data::Save("tests/data/TestsKMeansSilhouette/Example2/newCentroids.csv", KClusters.getCentroids(), true);
	data::Save("tests/data/TestsKMeansSilhouette/Example2/SilhouetteIndividually.csv", KClusters.getIndividualSilhouette(), true);
	data::Save("tests/data/TestsKMeansSilhouette/Example2/SilhouetteClusters.csv", clusterSilhouettes, true);
