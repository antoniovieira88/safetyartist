...
int KMeansTest4()
{
	...
	data::Load("tests/data/TestsKMeansSilhouette/Example4/data.csv", data, true);
	data::Load("tests/data/TestsKMeansSilhouette/Example4/centroids.csv", centroids, true);

	std::cout << "Test started" << endl;

	KMeans KClusters(data, 6, centroids, false);
	...
	data::Save("tests/data/TestsKMeansSilhouette/Example4/assignments.csv", KClusters.getAssigments(), true);
	data::Save("tests/data/TestsKMeansSilhouette/Example4/newCentroids.csv", KClusters.getCentroids(), true);
	data::Save("tests/data/TestsKMeansSilhouette/Example4/SilhouetteIndividually.csv", KClusters.getIndividualSilhouette(), true);
	data::Save("tests/data/TestsKMeansSilhouette/Example4/SilhouetteClusters.csv", clusterSilhouettes, true);
